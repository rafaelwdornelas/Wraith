# Wraith 1.0.0 - minimal profile (amalgamated)

Bare loader. No forwarder resolution, no delay-load imports, no bound-import handling. The right pick when you control the payload DLL and can guarantee it has no exotic import dependencies.
...
- 30 compilation units from `src/`
- 7 public + 33 internal headers
- (no asm - indirect syscalls compiled out)
