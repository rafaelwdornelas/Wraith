 ...
 * CMake source tree with -DWRAITH_PROFILE=minimal, but condensed
 * into two files (.c + .h) for fast integration.
 *
 * To regenerate: from the project root, run
 *     python3 tools/amalgamate.py minimal
 *
...
#  define WRAITH_FORWARDED_EXPORTS 0
#endif
#ifndef WRAITH_DELAY_LOAD_IMPORTS
#  define WRAITH_DELAY_LOAD_IMPORTS 0
#endif
#ifndef WRAITH_BOUND_IMPORTS
#  define WRAITH_BOUND_IMPORTS 0
#endif
...
#  define WRAITH_PROFILE_NAME "minimal"
#endif
