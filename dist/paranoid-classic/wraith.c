 ...
 * CMake source tree with -DWRAITH_PROFILE=paranoid-classic, but condensed
 * into two files (.c + .h) for fast integration.
 *
 * To regenerate: from the project root, run
 *     python3 tools/amalgamate.py paranoid-classic
 *
...
#  define WRAITH_PROFILE_NAME "paranoid-classic"
#endif
