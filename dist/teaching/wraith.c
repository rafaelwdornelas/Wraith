 ...
 * CMake source tree with -DWRAITH_PROFILE=teaching, but condensed
 * into two files (.c + .h) for fast integration.
 *
 * To regenerate: from the project root, run
 *     python3 tools/amalgamate.py teaching
 *
...
#  define WRAITH_USE_HOST_IAT_REDIRECT 1
#endif
#ifndef WRAITH_DEBUG_LOG
#  define WRAITH_DEBUG_LOG 1
#endif
#ifndef WRAITH_TRACE_PIPELINE
#  define WRAITH_TRACE_PIPELINE 1
#endif
...
#  define WRAITH_PROFILE_NAME "teaching"
#endif
