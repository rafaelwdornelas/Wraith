# Wraith 1.0.0 - default profile (amalgamated)

Reliability features ON, all stealth OFF. The smallest and most predictable build - useful for first-time integration smoke tests or for embedding where stealth is irrelevant (e.g. CTF judge).
